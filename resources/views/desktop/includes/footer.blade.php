    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-12 single-footer-widget">
                <h4>Наши тренажеры</h4>
                <ul>
                    <li><a href="/make">Тренировка устного счета</a></li>
                    <li><a href="/tasks">Решать уравнения</a></li>
                    <li><a href="/table">Учить таблицу умножения примеры</a></li>
                    <li><a href="/comp">Решать неравенства</a></li>
            ...
            <div class="col-lg-4 col-md-12 single-footer-widget">
                <!-- Yandex.RTB R-A-741366-12 -->
                <div id="yandex_rtb_R-A-741366-12"></div>
                <script>window.yaContextCb.push(()=>{
                        Ya.Context.AdvManager.render({
                            renderTo: 'yandex_rtb_R-A-741366-12',
                            blockId: 'R-A-741366-12'
                        })
                    })</script>
            </div>
            <div class="col-lg-4 col-md-12 single-footer-widget">
                <div class="footer_form_thanks">
                    <h4>Скажите спасибо за занятия!</h4>
                    <div class="footer_form_thanks_title">Вы помогаете нам развиваться, добавлять новые уроки и тренажеры</div>
                    ...
                    <form class="yoomoney-payment-form" action="https://yookassa.ru/integration/simplepay/payment" method="post" accept-charset="utf-8" >
                        ...
                        <input name="shopId" type="hidden" value="833066"></form>
                    <script src="https://yookassa.ru/integration/simplepay/js/yookassa_construct_form.js"></script>
                </div>
            </div>
        </div>
        <div class="footer-bottom row align-items-center">
            <p class="footer-text m-0 col-lg-8 col-md-12">Присоединяйтесь к нам в соцсетях</p>
            <div class="col-lg-4 col-md-12 footer-social">
                <a href="https://www.facebook.com/profile.php?id=100072081377512"><i class="fa fa-facebook"></i></a>
                <a href="https://twitter.com/i/connect_people"><i class="fa fa-twitter"></i></a>
                <a href="https://vk.com/public203082824"><i class="fa fa-vk"></i></a>
                <a href="#"><i class="fa fa-instagram"></i></a>
                <a href="#"><i class="fa fa-youtube"></i></a>
            </div>
            <p style="color:#777777" class="footer_sogl">© Простая математика 2021 год ИНН 300512233408
                <a href="/doc/soglasie.pdf"  style="color:#777777" target="_blank">Пользовательское соглашение</a></p>
        </div>
    </div>
</footer>
<!-- End Footer Area -->
