...
@section('content')
<form method="POST" action="/admin/main_page_banners/store" class="form-horizontal" enctype="multipart/form-data">
    {!! csrf_field() !!}
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            ...
            <a class="btn btn-info" href="/admin/main_page_banners">Отмена</a>
        </div>
    </div>
</form>
@endsection