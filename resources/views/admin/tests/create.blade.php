...
@section('content')
<form method="POST" action="/admin/tests/store" class="form-horizontal" enctype="multipart/form-data">
    {!! csrf_field() !!}
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input type="text" required="required" class="form-control" id="inputName" name="questions">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <textarea required="required" class="form-control"  rows="8" id="inputText" name="value"></textarea>
        </div>
    </div>
